...
myOwnPromise.prototype.then = function(onResolve) {
  this.promiseChain.push(onResolve)
  return this
}

myOwnPromise.prototype.onResolve = function(value) {
  this.promiseChain.forEach(function(nextFn) {
    nextFn(value)
  })
}
...
let promise = new myOwnPromise(function(resolve) {
...
let asyncCall = function() {
  return new myOwnPromise(function(resolve) {
    setTimeout(function() {
        resolve(42)
    }, 1000)
...
asyncCall().then(function(val) { console.log(val)})
